...
use crate::{partial_turbulate, stencilate, utilities::complex_random_gaussian, Tensors};
...
fn rustmann(_py: Python<'_>, m: &PyModule) -> PyResult<()> {
    ...
    fn partial_turbulate_f64<'py>(
        ...
        let (U_f, V_f, W_f) = partial_turbulate(&stencil.as_array(), seed, Nx, Ny, Nz, Lx, Ly, Lz);
